...
public class TinyDB {
    ...
    public ArrayList<PkmonInstance> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<PkmonInstance> objects =  new ArrayList<PkmonInstance>();

    	for(String jObjString : objStrings){
    		PkmonInstance value  = gson.fromJson(jObjString,  PkmonInstance.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public  Bag getObject(String key, Class<?> classOfT){

        String json = getString(key);
        Bag value = new Gson().fromJson(json, Bag.class);
        if (value == null)
    ...
    public void putListObject(String key, ArrayList<PkmonInstance> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
